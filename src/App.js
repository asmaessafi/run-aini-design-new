...
function Layout({ children }) {
  ...
  const noLayoutRoutes = ['/signup', '/login', '/forgot-password', '/administration',
    '/administration/player-management', '/administration/coach-management', '/administration/dashboard',
    '/administration/agenda-management', '/administration/payment-management',
    '/administration/settings', '/administration/profile', '/administration/contact',
...
function App() {
  ...
  useEffect(() => {
    ...
    setCoaches([
      { id: 'c1', name: 'Coach 1', email: 'coach1@example.com' },
      { id: 'c2', name: 'Coach 2', email: 'coach2@example.com' },
    ]);
  }, []);
              ...
              <Routes>
                ...
                <Route path="/administration" element={<AdministrationLayout />}>
                  ...
                  <Route 
                    ...
                    element={<CoachManagement coaches={coaches} setCoaches={setCoaches} />} 
                  />
                  <Route 
