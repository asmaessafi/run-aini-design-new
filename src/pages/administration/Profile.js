...
import { 
  ...
  FiChevronRight, FiEye, FiSettings, FiFacebook, FiInstagram,
  FiGlobe as FiWeb
} from 'react-icons/fi';
import { 
  FaFacebook, 
...
const Profile = () => {
  ...
  const renderContent = () => {
    switch(activeTab) {
      ...
      case 'settings':
        return (
          <SectionCard title="Settings" icon={<FiSettings size={20} />}>
            <div className="space-y-4">
              <div className="p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                ...
                <button className="text-[#80a8ff] text-sm font-medium hover:text-white transition-colors flex items-center">
                  Go to Settings <FiChevronRight className="ml-1" />
                </button>
              </div>
              
              <div className="p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                <h3 className="font-semibold text-white mb-2">Privacy Settings</h3>
                <p className="text-gray-400 text-sm mb-4">Control your privacy and data sharing preferences</p>
                <button className="text-[#80a8ff] text-sm font-medium hover:text-white transition-colors flex items-center">
                  Manage Privacy <FiChevronRight className="ml-1" />
                </button>
              </div>
              
              <div className="p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                <h3 className="font-semibold text-white mb-2">Notifications</h3>
                <p className="text-gray-400 text-sm mb-4">Configure your notification preferences</p>
                <button className="text-[#80a8ff] text-sm font-medium hover:text-white transition-colors flex items-center">
